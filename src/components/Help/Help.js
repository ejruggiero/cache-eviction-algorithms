...
export const Help = () => {
  ...
  const text = (
    ...
    <p>Hello! Here you will learn three important cache eviction algorithms: first in first out (FIFO),
     least recently used (LRU), and least frequently used (LFU). It is recommended to first practice FIFO, then LRU, then LFU.</p>
    ...
    <p>The cache is represented by a gray rectangle near the center of the screen. <img src={cache} alt="Cache" width={100} height={25}/> It has a capacity of 5 data elements, and <b>a data element is added to the cache before the one to its right.</b> Data elements are represented as yellow circles containing emojis 
     ...
     <p>Your score can be found at the top right corner of the screen. <img src={score} alt="Score" width={150} height={38}/> If you select the correct element to remove from the cache, then you will 
     gain 1 point.</p>
