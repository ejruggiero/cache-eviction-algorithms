...
export const Help = () => {
  ...
  const text = (
    ...
    <p>The cache is represented by a gray rectangle <img src={cache} alt="Cache" width={100} height={25}/> near the center of the screen. It has a capacity of 5 data elements, and <b>a data element is added to the cache before the one to its right.</b> Data elements are represented as yellow circles containing emojis 
