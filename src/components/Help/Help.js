...
export const Help = () => {
  ...
  const text = (
    ...
    <p>Hello! Here you will learn three important cache eviction algorithms: first in first out (FIFO),
     least recently used (LRU), and least frequently used (LFU).</p>
    ...
    <p>The cache is represented by a gray rectangle near the center of the screen. <img src={cache} alt="Cache" width={100} height={25}/> It has a capacity of 5 data elements. Data elements are represented as yellow circles containing emojis 
